...
class trainloader(Dataset): 
  def __init__(self, dataset):
    ...
    # self.transforms = SimSiamTransform(input_size=224)
    self.transforms = VICRegTransform(input_size=224)
    # self.transforms = BYOLTransform(view_1_transform=BYOLView1Transform(input_size=224),
    #                                 view_2_transform=BYOLView2Transform(input_size=224))
...
def loader(source, batch_size, shuffle=True,  num_workers=0, fine_tune=False):
